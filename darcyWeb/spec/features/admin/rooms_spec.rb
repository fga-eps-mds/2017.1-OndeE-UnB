...
describe 'Rooms', type: :feature do
  ...
  context "access rooms" do
    ...
    it "Should Not save room if has not level", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
    ...
    it "Should Not save room if has not latitude", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
    ...
    it "Should Not save room if has not longitude", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
    ...
    it "Should Not save room if has not GeoData", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
    ...
    it "Should Not save room without related building", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
    ...
    it "Should Not save room without room type", js: true  do
      FactoryGirl.create :building
      room = FactoryGirl.build :room
